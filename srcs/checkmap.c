...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/04/22 17:47:11 by taquino-          #+#    #+#             */
/*   Updated: 2024/04/22 17:47:12 by taquino-         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	ft_charvalidation(t_game	*game)
{
	while (game->map.mgrid[game->map.mheight])
	{
		...
		{
			if (ft_strchr("01CEP", game->map.mgrid[game->map.mheight]
					[game->map.mwidth]) == 0)
...
int	ft_checkmap(t_game *game)
{
	...
	if (game->map.mwidth == 0)
		...
		ft_printf("Map should have only 0, 1, C, E, P characters\n");
